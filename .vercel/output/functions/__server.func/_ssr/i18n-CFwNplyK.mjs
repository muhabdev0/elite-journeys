...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-CFwNplyK.js
...
var translations = {
	ar: {
		...
		hero: {
			...
			title1: "اكتشف أوروبا",
			title2: "بأسلوبٍ راقٍ",
			subtitle: "رحلات سياحية خاصة · نقل موثوق · سائقون عرب محترفون يتحدثون لغتك",
		...
		blog: {
			...
			subtitle: "نصائح مختارة، أدلة وجهات، وقصص من طرقات أوروبا لنساعدك في تخطيط رحلة لا تُنسى.",
	...
	en: {
		...
		hero: {
			...
			subtitle: "Private tours · reliable transport · professional Arabic-speaking drivers at your service",
		...
		blog: {
			...
			subtitle: "Curated tips, destination guides, and stories from the roads of Europe to help you plan an unforgettable trip.",
			readMore: "Read more",
			back: "Back to Blog",
...
//#endregion
export { useLang as n, LanguageProvider as t };
