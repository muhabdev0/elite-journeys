...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "author",
				content: "ALASWANI Tourism & Transport"
			},
			{
				property: "og:type",
				content: "website"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;900&family=Playfair+Display:ital,wght@0,500;0,700;1,700&family=Inter:wght@400;500;600;700&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-D_PtLPKg.mjs");
var Route$1 = createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "ALASWANI · Luxury Tourism & Transport in Europe" },
		{
			name: "description",
			content: "Private European tours, reliable luxury transport, and professional Arabic-speaking drivers. Discover Europe in true style with ALASWANI."
		},
		{
			property: "og:title",
			content: "ALASWANI · Luxury Tourism & Transport in Europe"
		},
		{
			property: "og:description",
			content: "Private tours, premium fleet, Arabic-speaking drivers across 15+ European destinations."
		}
	] }),
...
var Route = createFileRoute("/blog/")({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Travel guides, destination inspiration, and practical tips for exploring Europe with a private Arabic-speaking driver."
			},
			{
				property: "og:title",
				content: "Blog · ALASWANI Tourism & Transport"
			},
			{
				property: "og:description",
				content: "Travel guides and destination inspiration from ALASWANI Tourism & Transport."
			},
			{
				property: "og:url",
				content: "/blog"
